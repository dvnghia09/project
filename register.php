<?php 
  ...
  if (isset($_POST['email'])) {
    ...
    if ($query) {
      $err['faile'] = 'Đăng Ký Thành Công , Vui Lòng Đăng Nhập Tài Khoản Của Bạn';
    }
  }

  // if (isset($_POST['email-lg'])) {
  //   $email_lg = $_POST['email-lg'];
  //   $pass_lg = $_POST['password-lg'];
...
<body>
  <div class="header_login">
      ...
      <h2 class="header_login_name_sub">Đăng ký</h2>
  </div>
  <div class="modal">
    <!-- form đăng ký -->
    <div class="modal__form modal__form-active">
      ...
      <div class="modal__form-container">
        ...
        <?php foreach ($err as $key => $value): ?>
            <h2 class="err"><?php echo $value ?></h2>
          <?php endforeach ?>

        <div class="modal__form-header">
                 
          <h3 class="modal__form-heading">Đăng ký</h3>
          <a href="login.php" class="modal__form-btn">Đăng nhập</a>
        </div>
        <form class="modal__form-form" method="POST">
              ...
              <div class="modal__form-group">
                <input type="password" class="modal__form-control" placeholder="Nhập lại mật khẩu của bạn">
              </div>


              <div class="modal__form-note">
              <p class="modal__form-text">Bằng việc đăng kí, bạn đã đồng ý với chúng tôi về 
              <a href="" class="modal__form-text-link">Điều khoản dịch vụ</a> &
              <a href="" class="modal__form-text-link">Chính sách bảo mật</a></p>
          </div>
